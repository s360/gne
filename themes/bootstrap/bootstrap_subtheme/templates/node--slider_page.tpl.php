...
?>
<div  title="#!<?php echo $alias ?>"  id="<?php echo $alias ?>" class="body-content <?php if($css_classes) echo $css_classes; ?>" style="<?php if(!empty ($img_url)): ?>background-image: url('<?php echo $img_url; ?>')<?php endif;?>">
