...
?>
<div  title="#!<?php echo $alias ?>"  id="<?php echo $alias ?>" class="node node-press-release <?php if($css_classes) echo $css_classes; ?>" <?php if($img_url)?>style="background-image: url('<?php echo $img_url; ?>')">
