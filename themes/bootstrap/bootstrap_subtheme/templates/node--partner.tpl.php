...
?>
<div title="<?php echo $title ?>"  data-hash="#!/<?php echo $alias ?>" id="<?php echo $alias ?>" class="node node-partner <?php if($css_classes) echo $css_classes; ?>" <?php if($img_url)?>style="background-image: url('<?php echo $img_url; ?>')">
